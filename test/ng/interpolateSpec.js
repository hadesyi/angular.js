...
describe('$interpolate', function() {
  ...
  describe('interpolating in a trusted context', function() {
    ...
    it('should interpolate trusted expressions in a wildcard trustedContext', inject(function($interpolate) {
      var foo = sce.trustAsCss("foo");
      expect($interpolate('{{foo}}', true, sce.ANY)({foo: foo})).toEqual('foo');
    }));
