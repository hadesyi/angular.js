  ...
  describe('pattern', function() {
    ...
    it('should throw an error when scope pattern can\'t be found', function() {
      expect(function() {
        ...
        scope.$apply();
      }).toThrow("[NgErr5] ngPattern error! Expected fooRegexp to be a RegExp but was undefined. " +
                  "Element: <input type=\"text\" ng-model=\"foo\" ng-pattern=\"fooRegexp\" class=\"ng-pristine ng-valid\">");
    });
  });
