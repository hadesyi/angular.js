...
module.exports = function(grunt) {
  ...
  grunt.registerTask('bower', 'Install Bower packages.', function () {
    ...
    console.log('==== about to install bower stuff ====');
    try {
      bower.commands.install()
        ...
        .on('end', function() {
            console.log('BOWER is done!');
            done();
        });
    } catch (e) {
      console.log('EXCEPTION FROM BOWER INSTALL: ', e);
      throw e;
    } finally {
      console.log('==== finished installing bower stuff ====');
    }
  });
};
